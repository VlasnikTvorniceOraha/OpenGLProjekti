...
public:
	...
	GLuint EBO;
	//konstruktor za mesh
	Mesh(std::vector<Vertex> vrhovi, std::vector<unsigned int> indeksi, vector<Texture> teksture);
	

	//setupaj buffere za slanje podataka grafickoj
	void ucitajBuffere();

	void Iscrtaj(Shader& sjencar, bool Culling, glm::mat4 Offset, Material material);
